...
public class EntityAttributes {
    ...
    public static float baseDefense1 = ((100.0F / GaiaConfig.Tier1baseDefense) * 0.01F) * (40.0F * (float) GaiaConfig.Tier1maxHealth / 100.0F);
    public static float baseDefense2 = ((100.0F / GaiaConfig.Tier2baseDefense) * 0.01F) * (80.0F * (float) GaiaConfig.Tier2maxHealth / 100.0F);
    public static float baseDefense3 = ((100.0F / GaiaConfig.Tier3baseDefense) * 0.01F) * (160.0F * (float) GaiaConfig.Tier3maxHealth / 100.0F);
