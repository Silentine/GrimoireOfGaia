...
public class EntityAttributes {
	...
	public static final float MAX_HEALTH_1 = 40.0F * (float) GaiaConfig.Tier1maxHealth / 100.0F;
	public static final float MAX_HEALTH_2 = 80.0F * (float) GaiaConfig.Tier2maxHealth / 100.0F;
	public static final float MAX_HEALTH_3 = 160.0F * (float) GaiaConfig.Tier3maxHealth / 100.0F;
	...
	public static final float ATTACK_DAMAGE_1 = 4.0F * (float) GaiaConfig.Tier1attackDamage / 100.0F;
	public static final float ATTACK_DAMAGE_2 = 8.0F * (float) GaiaConfig.Tier2attackDamage / 100.0F;
	public static final float ATTACK_DAMAGE_3 = 12.0F * (float) GaiaConfig.Tier3attackDamage / 100.0F;
	...
	public static final float BASE_DEFENSE_1 = ((100.0F / GaiaConfig.Tier1baseDefense) * 0.01F) * (40.0F * (float) GaiaConfig.Tier1maxHealth / 100.0F);
	public static final float BASE_DEFENSE_2 = ((100.0F / GaiaConfig.Tier2baseDefense) * 0.01F) * (80.0F * (float) GaiaConfig.Tier2maxHealth / 100.0F);
	public static final float BASE_DEFENSE_3 = ((100.0F / GaiaConfig.Tier3baseDefense) * 0.01F) * (160.0F * (float) GaiaConfig.Tier3maxHealth / 100.0F);
