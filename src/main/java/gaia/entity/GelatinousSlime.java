...
public class GelatinousSlime extends AbstractGaiaEntity {
	...
	public void aiStep() {
		...
		this.beaconMonster(4, (entity) -> {
			if (!(entity instanceof Player)) {
				entity.addEffect(new MobEffectInstance(MobEffects.SLOWNESS, 100, 1, true, true));
			}
		});
	...
	public static boolean checkGelatinousSlimeSpawnRules(EntityType<? extends Monster> entityType, ServerLevelAccessor levelAccessor, EntitySpawnReason spawnType, BlockPos pos, RandomSource random) {
