...
public class EntityGaiaSpawnerVampire extends EntityMobProp {

	private boolean spawned;

	public EntityGaiaSpawnerVampire(World worldIn) {
		super(worldIn);
		/**
	...
	private void setSpawn() {
		EntityGaiaVampire entity;

		entity = new EntityGaiaVampire(world);
