...
public class EntityGaiaPropCampfire extends EntityMobProp {
	...
	public EntityGaiaPropCampfire(World worldIn) {
		super(GaiaEntities.CAMPFIRE, worldIn);
		setSize(0.8F, 0.8F);
		experienceValue = 0;
	...
	public boolean canSpawn(IWorld worldIn, boolean value) {
		return posY < 60.0D && posY > 32.0D && world.getDifficulty() != EnumDifficulty.PEACEFUL && isValidLightLevel() && super.canSpawn(worldIn, value);
	}
	/* SPAWN CONDITIONS */
