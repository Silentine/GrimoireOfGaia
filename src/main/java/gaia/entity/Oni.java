...
public class Oni extends AbstractGaiaEntity {
	...
	public static boolean checkOniSpawnRules(EntityType<? extends Monster> entityType, ServerLevelAccessor levelAccessor, EntitySpawnReason spawnType, BlockPos pos, RandomSource random) {
