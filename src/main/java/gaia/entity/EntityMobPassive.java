...
/** 
 * This is a direct copy of EntityMob
 * Used by assist mobs to not trigger the warning message when using a bed.
 * No additional changes have been made aside from the class name.
 * @see EntityMob
 */
public abstract class EntityMobPassive extends EntityCreature implements IMob {
	public EntityMobPassive(World worldIn) {
		super(worldIn);
	...
	public boolean attackEntityFrom(DamageSource DamageSource, float inputDamage) {
		return this.isEntityInvulnerable(DamageSource) ? false : super.attackEntityFrom(DamageSource, inputDamage);
	}
