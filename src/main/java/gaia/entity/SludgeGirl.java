...
public class SludgeGirl extends AbstractGaiaEntity {
	...
	public static boolean checkSludgeGirlSpawnRules(EntityType<? extends Monster> entityType, ServerLevelAccessor levelAccessor, EntitySpawnReason spawnType, BlockPos pos, RandomSource random) {
