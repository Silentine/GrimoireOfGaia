...
public class EntityAIGaiaArcher extends EntityAIBase
{
    private IGaiaArcher archer;
    ...
    public EntityAIGaiaArcher(IGaiaArcher entity, double speedAmplifier, int delay, float maxDistance)
    {
    ...
    {	
        ...
        if (entitylivingbase != null)
        {
            ...
            {
                this.entity.getNavigator().tryMoveToEntityLiving(entitylivingbase, this.moveSpeedAmp*0.8);
                this.strafingTime = -1;
            }
