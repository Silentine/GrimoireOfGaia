...
//	});
	...
	public EntityMobAssistBase(EntityType<?> type, World worldIn) {
		super(type, worldIn);
	...
	static class AINearestAttackableHostileTarget extends EntityAINearestAttackableTarget<EntityLiving> {
		public AINearestAttackableHostileTarget(EntityMobAssistBase passive) {
			super(passive, EntityLiving.class, 10, false, true, EntityMobAssistBase.PASSIVE_SELECTOR);
		}
	}
}
