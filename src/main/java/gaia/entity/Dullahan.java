...
public class Dullahan extends AbstractGaiaEntity {
	...
	public boolean hurtServer(ServerLevel level, DamageSource source, float damage) {
		...
		if (source.getEntity() instanceof Player player) {
			...
			if (itemstack.is(GaiaTags.GOLDEN_TOOLS)) {
				damage = ToolMaterial.GOLD.attackDamageBonus() * 8;
			}
		}
	...
	public static boolean checkDullahanSpawnRules(EntityType<? extends Monster> entityType, ServerLevelAccessor levelAccessor, EntitySpawnReason spawnType, BlockPos pos, RandomSource random) {
