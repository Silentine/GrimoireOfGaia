...
public class EntityGaiaKobold extends EntityMobHostileBase implements GaiaIRangedAttackMob {
	...
	private EntityAIAttackMelee aiAttackOnCollide = new EntityAIAttackMelee(this, EntityAttributes.ATTACK_SPEED_1, true) {
		public void resetTask() {
			super.resetTask();
			EntityGaiaKobold.this.setSwingingArms(false);
		}

		public void startExecuting() {
			super.startExecuting();
			EntityGaiaKobold.this.setSwingingArms(true);
		}
	};

	private static final DataParameter<Boolean> SWINGING_ARMS = EntityDataManager.createKey(EntityGaiaKobold.class, DataSerializers.BOOLEAN);
	...
	protected ResourceLocation getLootTable() {
		return GaiaLootTables.ENTITIES_GAIA_KOBOLD;
	}
