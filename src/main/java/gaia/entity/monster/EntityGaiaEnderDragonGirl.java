...
public class EntityGaiaEnderDragonGirl extends EntityMobPassiveBase {
    ...
    private static final DataParameter<Optional<IBlockState>> CARRIED_BLOCK =
            EntityDataManager.<Optional<IBlockState>>createKey(EntityGaiaEnderDragonGirl.class, DataSerializers.OPTIONAL_BLOCK_STATE);
    private static final DataParameter<Boolean> SCREAMING =
            EntityDataManager.<Boolean>createKey(EntityGaiaEnderDragonGirl.class, DataSerializers.BOOLEAN);
    ...
    public void writeEntityToNBT(NBTTagCompound tag) {
        ...
        if (iblockstate != null) {
            ...
            tag.setShort("carriedData", (short) iblockstate.getBlock()
    ...
    static class AIFindPlayer extends EntityAINearestAttackableTarget<EntityPlayer> {
        ...
        public boolean shouldExecute() {
            ...
            List<EntityPlayer> list =
                    this.taskOwner.world.<EntityPlayer>getEntitiesWithinAABB(EntityPlayer.class, this.taskOwner.getEntityBoundingBox()
    ...
    static class AIPlaceBlock extends EntityAIBase {
        ...
        public boolean shouldExecute() {
            return this.enderman.getHeldBlockState() == null
                    ? false
                    : (!this.enderman.world.getGameRules()
                            .getBoolean("mobGriefing")
                                    ? false
                                    : this.enderman.getRNG()
                                            .nextInt(2000) == 0);
        }
        ...
        private boolean canPlaceBlock(World p_188518_1_, BlockPos p_188518_2_, Block p_188518_3_, IBlockState p_188518_4_, IBlockState p_188518_5_) {
            return !p_188518_3_.canPlaceBlockAt(p_188518_1_, p_188518_2_)
                    ? false
                    : (p_188518_4_.getMaterial() != Material.AIR
                            ? false
                            : (p_188518_5_.getMaterial() == Material.AIR
                                    ? false
                                    : p_188518_5_.isFullCube()));
        }
    }
    ...
    static class AITakeBlock extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            RayTraceResult raytraceresult = world.rayTraceBlocks(new Vec3d((double) ((float) MathHelper.floor(this.enderman.posX) +
                    0.5F), (double) ((float) j + 0.5F), (double) ((float) MathHelper.floor(this.enderman.posZ) + 0.5F)),
                    new Vec3d((double) ((float) i + 0.5F), (double) ((float) j +
