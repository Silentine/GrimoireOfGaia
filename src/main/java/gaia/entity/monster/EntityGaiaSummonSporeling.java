...
//		this.tasks.addTask(2, new EntityAIWander(this, 1.0D));
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(((double)EntityAttributes.maxHealth1) * 0.50);
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue((double)EntityAttributes.moveSpeed1);
		this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(((double)EntityAttributes.attackDamage1) * 0.50);
