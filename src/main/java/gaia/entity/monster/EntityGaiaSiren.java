...
public class EntityGaiaSiren extends EntityMobHostileDay implements IGaiaArcher {
	...
	private static final DataParameter<Boolean> HOLDING_BOW = EntityDataManager.<Boolean>createKey(EntityGaiaSiren.class, DataSerializers.BOOLEAN);
