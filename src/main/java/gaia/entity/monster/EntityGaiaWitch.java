...
public class EntityGaiaWitch extends EntityMobHostileBase implements IRangedAttackMob {
    ...
    public void setAggressive(boolean aggressive) {
        this.getDataManager()
                .set(IS_AGGRESSIVE, Boolean.valueOf(aggressive));
    }

    public boolean isDrinkingPotion() {
        return ((Boolean) this.getDataManager()
                .get(IS_AGGRESSIVE)).booleanValue();
    }
    ...
    public void onLivingUpdate() {
        ...
        if (this.getHealth() < EntityAttributes.maxHealth2 * 0.75F && this.getHealth() > 0.0F && this.spawn == 0) {
            ...
            if (!this.world.isRemote) {
                spawnMob = new EntitySpider(this.world);
        ...
        if (!this.world.isRemote) {
            if (this.isDrinkingPotion()) {
                ...
                if (potiontype != null) {
                    ...
                    this.witchAttackTimer = this.getHeldItemMainhand()
                            .getMaxItemUseDuration();
                    this.setAggressive(true);
                    this.world.playSound((EntityPlayer) null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_WITCH_DRINK,
    ...
    protected void entityInit() {
        super.entityInit();
        this.getDataManager()
                .register(IS_AGGRESSIVE, Boolean.valueOf(false));
    }
