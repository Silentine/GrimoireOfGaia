...
public class EntityGaiaHunter extends EntityMobPassiveDay implements IGaiaArcher {
	...
	public EntityGaiaHunter(World par1World) {
		...
		this.tasks.addTask(1, new EntityAIAvoidEntity(this, EntityPlayer.class, 2.0F, 1.0D, EntityAttributes.attackSpeed1));
