...
public class Cyclops extends AbstractAssistGaiaEntity implements IDayMob {
	...
	public static boolean checkCyclopsSpawnRules(EntityType<? extends Monster> entityType, ServerLevelAccessor levelAccessor, EntitySpawnReason spawnType, BlockPos pos, RandomSource random) {
