...
//	}
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		if (shiftPressed) {
			...
			tooltip.add(new TranslationTextComponent("text.grimoireofgaia.InventoryImmunity").appendSibling(new StringTextComponent(" ")).appendSibling(new TranslationTextComponent("effect.minecraft.poison")) );
		} else {
