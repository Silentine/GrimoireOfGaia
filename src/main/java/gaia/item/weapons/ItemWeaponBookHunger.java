...
public class ItemWeaponBookHunger extends ItemWeaponBook {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(new TranslationTextComponent("effect.minecraft.hunger").appendSibling(new StringTextComponent(" (0:04)")));
	}
	...
	public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity host) {
		...
		target.addPotionEffect(new EffectInstance(Effects.HUNGER, 80, 0));
		return true;
	}
}
