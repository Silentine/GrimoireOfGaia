...
public class ItemWeaponBookNature extends ItemWeaponBook {
	
	public ItemWeaponBookNature(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(new TranslationTextComponent("effect.minecraft.poison").appendSibling(new StringTextComponent(" (0:04)")));
	}
