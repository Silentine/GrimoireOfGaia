...
public class ItemWeaponBookNightmare extends ItemWeaponBook {
	...
	public ItemWeaponBookNightmare(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(new TranslationTextComponent("effect.minecraft.mining_fatigue").appendSibling(new StringTextComponent(" II")).appendSibling(new StringTextComponent(" (0:04)")));
	}
	...
	public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity host) {
		...
		target.addPotionEffect(new EffectInstance(Effects.MINING_FATIGUE, 80, 1));
		return true;
	}
}
