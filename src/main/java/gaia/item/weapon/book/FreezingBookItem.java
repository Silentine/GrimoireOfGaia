...
public class FreezingBookItem extends WeaponBookItem {
	public FreezingBookItem(ToolMaterial material, Properties properties) {
	...
	public void appendHoverText(ItemStack itemStack, TooltipContext context, TooltipDisplay display, Consumer<Component> builder, TooltipFlag tooltipFlag) {
		...
		builder.accept(Component.translatable(MobEffects.SLOWNESS.value().getDescriptionId()).append(" II (0:04)"));
	}
	...
	public void executeHurtEffect(ItemStack stack, LivingEntity target, LivingEntity attacker) {
		super.executeHurtEffect(stack, target, attacker);
