...
public class HungerBookItem extends WeaponBookItem {
	public HungerBookItem(ToolMaterial material, Properties properties) {
	...
	public void appendHoverText(ItemStack itemStack, TooltipContext context, TooltipDisplay display, Consumer<Component> builder, TooltipFlag tooltipFlag) {
		...
		builder.accept(Component.translatable(MobEffects.HUNGER.value().getDescriptionId()).append(" II (0:04)"));
	}
