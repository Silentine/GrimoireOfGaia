...
public class NatureBookItem extends WeaponBookItem {
	public NatureBookItem(ToolMaterial material, Properties properties) {
	...
	public void appendHoverText(ItemStack itemStack, TooltipContext context, TooltipDisplay display, Consumer<Component> builder, TooltipFlag tooltipFlag) {
		...
		builder.accept(Component.translatable(MobEffects.POISON.value().getDescriptionId()).append(" II (0:04)"));
	}
