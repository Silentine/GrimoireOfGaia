...
public class BattleBookItem extends WeaponBookItem {
	public BattleBookItem(ToolMaterial material, Properties properties) {
	...
	public void appendHoverText(ItemStack itemStack, TooltipContext context, TooltipDisplay display, Consumer<Component> builder, TooltipFlag tooltipFlag) {
		...
		builder.accept(Component.translatable(MobEffects.WEAKNESS.value().getDescriptionId()).append(" II (0:04)"));
	}
