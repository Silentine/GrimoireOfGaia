...
public class EntityGaiaPropCampfire extends EntityMobProp {
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		...
		if (canSpawn() && world.getDifficulty() != EnumDifficulty.PEACEFUL) {
			for (int i = 0; i < 2; i++) {
		...
		//TODO Block remains despite entity despawning
//		if (!world.isRemote) {
...
//		}
	...
	public boolean getCanSpawnHere() {
		return posY < ((!GaiaConfig.SPAWN.disableYRestriction) ? 60D : 512D) && posY > ((!GaiaConfig.SPAWN.disableYRestriction) ? 32D : 0D) && super.getCanSpawnHere();
	}
	/* SPAWN CONDITIONS */
