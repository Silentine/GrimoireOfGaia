...
public class ClientProxy extends CommonProxy {
	...
	public void registerRenders() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaBeholder.class, renderManager -> new RenderGaiaBeholder(renderManager, med));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaGoblin.class, renderManager -> new RenderGaiaGoblin(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaGoblinFeral.class, renderManager -> new RenderGaiaGoblinFeral(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaGorgon.class, renderManager -> new RenderGaiaGorgon(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaMite.class, renderManager -> new RenderGaiaMite(renderManager, small));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaHarpyWizard.class, renderManager -> new RenderGaiaHarpyWizard(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaHorse.class, renderManager -> new RenderGaiaHorse(renderManager, large));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaIllagerFire.class, renderManager -> new RenderGaiaIllagerFire(renderManager, large));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaIllagerInquisitor.class, renderManager -> new RenderGaiaIllagerInquisitor(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaKikimora.class, renderManager -> new RenderGaiaKikimora(renderManager, small));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaMandragora.class, renderManager -> new RenderGaiaMandragora(renderManager, small));
		...
		/* PROP */
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaPropAntHill.class, renderManager -> new RenderGaiaPropAntHill(renderManager, small));
		...
		/* SPAWNERS */
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaSpawnerBeholder.class, renderManager -> new RenderGaiaSpawner(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaSpawnerEnderDragonGirl.class, renderManager -> new RenderGaiaSpawner(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaSpawnerGorgon.class, renderManager -> new RenderGaiaSpawner(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaSpawnerMinotaur.class, renderManager -> new RenderGaiaSpawner(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaSpawnerSphinx.class, renderManager -> new RenderGaiaSpawner(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaSpawnerValkyrie.class, renderManager -> new RenderGaiaSpawner(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaSpawnerVampire.class, renderManager -> new RenderGaiaSpawner(renderManager, small));		
		/* MOB */
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaIllagerButler.class, renderManager -> new RenderGaiaIllagerButler(renderManager, small));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaSporeling.class, renderManager -> new RenderGaiaSporeling(renderManager, tiny));
		...
		/* PROJECTILE */
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaProjectileBomb.class, renderManager -> new RenderGaiaProjectile(renderManager, GaiaItems.WEAPON_PROJECTILE_BOMB, 2.0F));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaProjectileBubble.class, renderManager -> new RenderGaiaProjectile(renderManager, GaiaItems.WEAPON_PROP_PROJECTILE_BUBBLE, 2.0F));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaProjectileMagic.class, renderManager -> new RenderGaiaProjectile(renderManager, GaiaItems.WEAPON_PROP_PROJECTILE_MAGIC, 2.0F));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaProjectileMagicRandom.class, renderManager -> new RenderGaiaProjectile(renderManager, GaiaItems.WEAPON_PROP_PROJECTILE_MAGIC_RANDOM, 2.0F));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaProjectilePoison.class, renderManager -> new RenderGaiaProjectile(renderManager, GaiaItems.WEAPON_PROP_PROJECTILE_POISON, 2.0F));
		RenderingRegistry.registerEntityRenderingHandler(EntityGaiaProjectileWeb.class, renderManager -> new RenderGaiaProjectile(renderManager, GaiaItems.WEAPON_PROP_PROJECTILE_WEB, 2.0F));
	}
