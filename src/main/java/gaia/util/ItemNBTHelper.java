...
//
//	/**
//	 * Gets the CompoundNBT in an ItemStack. Tries to init it previously in case there isn't one present
//	 **/
...
//	}
//
//	public static void putByte(ItemStack stack, String tag, byte b) {
...
//				? getNBT(stack).getBoolean(tag)
//				: defaultExpected;
//	}
//
//	public static byte getByte(ItemStack stack, String tag, byte defaultExpected) {
//		return verifyExistance(stack, tag)
//				? getNBT(stack).getByte(tag)
//				: defaultExpected;
//	}
//
//	public static short getShort(ItemStack stack, String tag, short defaultExpected) {
//		return verifyExistance(stack, tag)
//				? getNBT(stack).getShort(tag)
//				: defaultExpected;
//	}
//
...
//		return verifyExistance(stack, tag)
//				? getNBT(stack).getIntArray(tag)
//				: EMPTY_INT_ARRAY;
//	}
//
//	public static long getLong(ItemStack stack, String tag, long defaultExpected) {
//		return verifyExistance(stack, tag)
//				? getNBT(stack).getLong(tag)
//				: defaultExpected;
//	}
//
//	public static float getFloat(ItemStack stack, String tag, float defaultExpected) {
//		return verifyExistance(stack, tag)
//				? getNBT(stack).getFloat(tag)
//				: defaultExpected;
//	}
//
//	public static double getDouble(ItemStack stack, String tag, double defaultExpected) {
//		return verifyExistance(stack, tag)
//				? getNBT(stack).getDouble(tag)
//				: defaultExpected;
//	}
//
//	/**
