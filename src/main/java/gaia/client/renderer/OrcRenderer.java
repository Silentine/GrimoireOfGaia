...
public class OrcRenderer extends MobRenderer<Orc, OrcRenderState, OrcModel> {
	public static final Identifier[] ORC_LOCATIONS = new Identifier[]{
			GrimoireOfGaia.modLoc("textures/entity/orc/orc01.png"),
			GrimoireOfGaia.modLoc("textures/entity/orc/orc02.png"),
			GrimoireOfGaia.modLoc("textures/entity/orc/orc03.png")};
