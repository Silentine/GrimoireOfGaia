...
public class CentaurRenderer extends MobRenderer<Centaur, CentaurRenderState, CentaurModel> {
	public static final Identifier[] CENTAUR_LOCATIONS = new Identifier[]{
			GrimoireOfGaia.modLoc("textures/entity/centaur/centaur01.png"),
			GrimoireOfGaia.modLoc("textures/entity/centaur/centaur02.png")
	};
	public static final Identifier[] CENTAUR_MALE_LOCATIONS = new Identifier[]{
			GrimoireOfGaia.modLoc("textures/entity/centaur/centaur01_male.png"),
			GrimoireOfGaia.modLoc("textures/entity/centaur/centaur02_male.png")
	};
