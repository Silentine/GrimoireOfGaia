...
public class GaiaCobbleGolemRenderer extends MobRenderer<GaiaCobbleGolemEntity, ModelGaiaCobbleGolem<GaiaCobbleGolemEntity>> {
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(GaiaCobbleGolemEntity entity) {
        return texture;
    }

    @Override
    protected void applyRotations(GaiaCobbleGolemEntity entityLiving, float rotationPitch, float rotationYaw, float partialTicks) {
