...
public class GoblinRenderer extends MobRenderer<Goblin, GoblinRenderState, GoblinModel> {
	public static final Identifier[] GOBLIN_LOCATIONS = new Identifier[]{
			Identifier.fromNamespaceAndPath(GrimoireOfGaia.MOD_ID, "textures/entity/goblin/goblin01.png"),
			Identifier.fromNamespaceAndPath(GrimoireOfGaia.MOD_ID, "textures/entity/goblin/goblin02.png")};
