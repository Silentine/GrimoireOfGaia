...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaShaman<T extends MobEntity> extends ModelGaia<T> {
	...
	public ModelGaiaShaman() {
		...
		leftleg = new RendererModel(this, 24, 36);
		...
		RendererModel leftpauldron = new RendererModel(this, 80, 0);
		...
		RendererModel rightarmbracelet = new RendererModel(this, 66, 6);
		...
		RendererModel leftarmbracelet = new RendererModel(this, 78, 6);
		...
		backpack = new RendererModel(this, 66, 11);
		...
		waist1 = new RendererModel(this, 66, 18);
		...
		waist2 = new RendererModel(this, 66, 28);
		...
		RendererModel rightlegbracelet = new RendererModel(this, 94, 0);
		...
		RendererModel leftlegbracelet = new RendererModel(this, 94, 0);
