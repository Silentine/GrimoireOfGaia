...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaNineTails<T extends MobEntity> extends ModelGaia<T> {
	...
	private RendererModel tie;
	private RendererModel rightarmclothupper;
	private RendererModel leftarmclothupper;
	private RendererModel rightarmcloth;
	private RendererModel leftarmcloth;
	private RendererModel tail1;
	private RendererModel tail2;
	private RendererModel rightlegcloth;
	private RendererModel leftlegcloth;
	private RendererModel rightsandal;
	private RendererModel leftsandal;
	...
	public ModelGaiaNineTails() {
		...
		RendererModel rightear = new RendererModel(this, 36, 37);
		...
		RendererModel leftear = new RendererModel(this, 36, 37);
		leftear.mirror = true;
		...
		leftarmclothupper = new RendererModel(this, 64, 3);
		...
		rightarmcloth = new RendererModel(this, 64, 9);
		...
		leftarmcloth = new RendererModel(this, 64, 9);
		...
		leftlegcloth = new RendererModel(this, 86, 0);
		...
		rightsandal = new RendererModel(this, 86, 8);
		...
		leftsandal = new RendererModel(this, 86, 8);
