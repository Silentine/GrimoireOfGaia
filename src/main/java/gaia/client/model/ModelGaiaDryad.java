...
public class ModelGaiaDryad<T extends MobEntity> extends ModelGaia<T> {
	...
	public ModelGaiaDryad() {
		...
		headflower = new RendererModel(this, 36, 39);
		...
		RendererModel rightear = new RendererModel(this, 36, 33);
		...
		RendererModel leftear = new RendererModel(this, 36, 33);
		leftear.mirror = true;
		...
		waist1 = new RendererModel(this, 64, 0);
		...
		waist2 = new RendererModel(this, 64, 10);
