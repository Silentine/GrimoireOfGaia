...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaSiren<T extends MobEntity> extends ModelGaia<T> {
	...
	private RendererModel rightarmextra;
	private RendererModel leftarmextra;
	private RendererModel rightarmextralower;
	private RendererModel leftarmextralower;
	...
	public ModelGaiaSiren() {
		...
		RendererModel finright = new RendererModel(this, 36, 32);
		...
		RendererModel finleft = new RendererModel(this, 36, 32);
		...
		mantle = new RendererModel(this, 36, 42);
		...
		rightarmextra = new RendererModel(this, 24, 12);
		...
		leftarmextra = new RendererModel(this, 24, 36);
		...
		rightarmextralower = new RendererModel(this, 24, 20);
		...
		leftarmextralower = new RendererModel(this, 24, 44);
