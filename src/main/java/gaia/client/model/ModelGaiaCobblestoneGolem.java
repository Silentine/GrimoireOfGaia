...
public class ModelGaiaCobblestoneGolem<T extends GaiaCobblestoneGolemEntity> extends ModelGaia<T> {
	...
	public ModelGaiaCobblestoneGolem() {
		...
		RendererModel crown = new RendererModel(this, 32, 0);
		...
		rightshoulder = new RendererModel(this, 45, 0);
		...
		RendererModel rightarmupper = new RendererModel(this, 45, 17);
		...
		RendererModel rightarmlower = new RendererModel(this, 45, 33);
		...
		RendererModel righthand = new RendererModel(this, 45, 49);
		...
		leftshoulder = new RendererModel(this, 81, 0);
		...
		RendererModel leftarmupper = new RendererModel(this, 45, 17);
		...
		RendererModel leftarmlower = new RendererModel(this, 45, 33);
		...
		RendererModel lefthand = new RendererModel(this, 73, 49);
		...
		bodymid = new RendererModel(this, 0, 61);
		...
		bodylower = new RendererModel(this, 0, 45);
		...
		rightlegupper = new RendererModel(this, 45, 65);
		...
		RendererModel rightleglower = new RendererModel(this, 45, 79);
		...
		leftlegupper = new RendererModel(this, 45, 65);
		...
		RendererModel leftleglower = new RendererModel(this, 45, 79);
