...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaMonoeye<T extends MobEntity> extends ModelGaia<T> {
	...
	public ModelGaiaMonoeye() {
		...
		RendererModel hairribbon = new RendererModel(this, 36, 29);
		...
		RendererModel righthorn = new RendererModel(this, 36, 39);
		...
		RendererModel lefthorn = new RendererModel(this, 36, 39);
		...
		RendererModel rightarmpauldron = new RendererModel(this, 36, 43);
		...
		RendererModel leftarmpauldron = new RendererModel(this, 50, 43);
		...
		RendererModel rightarmgauntlet = new RendererModel(this, 36, 52);
		...
		RendererModel leftarmgauntlet = new RendererModel(this, 46, 52);
		...
		skirt = new RendererModel(this, 64, 0);
		...
		RendererModel rightlegupper = new RendererModel(this, 64, 10);
		...
		RendererModel leftlegupper = new RendererModel(this, 64, 10);
