...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaBaphomet<T extends MobEntity> extends ModelGaia<T> {
	...
	private RendererModel mantlefront;
	...
	public ModelGaiaBaphomet() {
		...
		RendererModel righthairclip = new RendererModel(this, 36, 14);
		...
		RendererModel lefthairclip = new RendererModel(this, 48, 14);
		...
		RendererModel righthair = new RendererModel(this, 36, 22);
		...
		RendererModel lefthair = new RendererModel(this, 36, 22);
		...
		RendererModel righthorn1 = new RendererModel(this, 36, 34);
		...
		RendererModel righthorn2 = new RendererModel(this, 36, 38);
		...
		RendererModel righthorn3 = new RendererModel(this, 36, 44);
		...
		RendererModel righthorn4 = new RendererModel(this, 36, 48);
		...
		RendererModel lefthorn1 = new RendererModel(this, 36, 34);
		...
		RendererModel lefthorn2 = new RendererModel(this, 36, 38);
		...
		RendererModel lefthorn3 = new RendererModel(this, 36, 44);
		...
		RendererModel lefthorn4 = new RendererModel(this, 36, 48);
		...
		RendererModel rightear = new RendererModel(this, 36, 46);
		...
		RendererModel leftear = new RendererModel(this, 36, 46);
		leftear.mirror = true;
		...
		cloak1 = new RendererModel(this, 64, 12);
		...
		cloak2 = new RendererModel(this, 64, 19);
		...
		cloak3 = new RendererModel(this, 64, 28);
		...
		RendererModel righthand = new RendererModel(this, 64, 39);
		...
		RendererModel lefthand = new RendererModel(this, 76, 39);
		...
		waist = new RendererModel(this, 64, 47);
		...
		RendererModel rightfoot = new RendererModel(this, 92, 0);
		rightfoot.addBox(-2F, 5F, -1.5F, 4, 8, 4);
		rightfoot.setRotationPoint(-2F, 11F, -0.5F);
		rightfoot.setTextureSize(64, 32);
		setRotation(rightfoot, 0F, 0F, 0F);
		RendererModel leftfoot = new RendererModel(this, 108, 0);
