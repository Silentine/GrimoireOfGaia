...
public class TileModelDollSlimeGirl extends Model implements IModelBust {
	...
	private RendererModel hairpinright;
	private RendererModel hairpinleft;
	private RendererModel hairright;
	private RendererModel hairleft;
	...
	public TileModelDollSlimeGirl() {
		...
		hairpinright = new RendererModel(this, 36, 14);
		...
		hairpinleft = new RendererModel(this, 52, 14);
		...
		hairright = new RendererModel(this, 36, 22);
		...
		hairleft = new RendererModel(this, 36, 22);
		...
		waist = new RendererModel(this, 36, 32);
