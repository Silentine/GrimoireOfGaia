...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaEnderEye<T extends MobEntity> extends ModelGaia<T> {

	private RendererModel anchor;
	private RendererModel body;
	private RendererModel eyelid1;
	private RendererModel eyelid2;
	...
	public ModelGaiaEnderEye() {
		...
		eyelid1 = new RendererModel(this, 0, 14);
		...
		eyelid2 = new RendererModel(this, 0, 29);
		...
		rightwing = new RendererModel(this, 98, 38);
