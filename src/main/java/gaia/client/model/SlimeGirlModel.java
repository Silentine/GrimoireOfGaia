...
public class SlimeGirlModel extends EntityModel<SlimeGirlRenderState> implements HeadedModel, ArmedModel {
	...
	@Override
	public void setupAnim(SlimeGirlRenderState state) {
