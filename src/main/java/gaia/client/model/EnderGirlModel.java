...
public class EnderGirlModel extends EntityModel<EnderGirlRenderState> implements HeadedModel, ArmedModel {
	...
	@Override
	public void setupAnim(EnderGirlRenderState state) {
