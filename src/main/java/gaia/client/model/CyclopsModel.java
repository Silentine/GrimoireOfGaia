...
public class CyclopsModel extends EntityModel<Cyclops> implements HeadedModel, ArmedModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hair = neck.addOrReplaceChild("hair", CubeListBuilder.create().texOffs(36, 14).addBox(-1.5F, -1.5F, -0.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.5F, 3.0F));
	...
	public void setupAnim(Cyclops cyclops, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		headeyes.visible = cyclops.tickCount % 60 == 0 && limbSwingAmount <= 0.1F;
