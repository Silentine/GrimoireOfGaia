...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaArachne<T extends MobEntity> extends ModelGaia<T> {
	...
	private RendererModel skull1;
	private RendererModel skull2;
	private RendererModel skull3;
	private RendererModel body1;
	private RendererModel body2;
	private RendererModel body3;
	private RendererModel body4;
	private RendererModel body5;
	private RendererModel leg7;
	...
	public ModelGaiaArachne() {
		...
		RendererModel righteye = new RendererModel(this, 36, 16);
		...
		RendererModel lefteye = new RendererModel(this, 36, 16);
		lefteye.mirror = true;
		...
		RendererModel leftarmlower = new RendererModel(this, 36, 28);
		...
		waist = new RendererModel(this, 36, 37);
		...
		skull1 = new RendererModel(this, 36, 56);
		...
		skull2 = new RendererModel(this, 36, 46);
		...
		skull3 = new RendererModel(this, 36, 56);
		...
		leg6 = new RendererModel(this, 92, 0);
		...
		leg7 = new RendererModel(this, 92, 0);
		...
		leg8 = new RendererModel(this, 92, 0);
