...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaWerecat<T extends MobEntity> extends ModelGaia<T> {
	...
	public ModelGaiaWerecat() {
		...
		leash = new RendererModel(this, 36, 35);
		...
		RendererModel leftarmlower = new RendererModel(this, 74, 0);
		...
		RendererModel leftfoot = new RendererModel(this, 88, 11);
		...
		RendererModel rightfootlower = new RendererModel(this, 88, 21);
		...
		RendererModel leftfootlower = new RendererModel(this, 88, 21);
