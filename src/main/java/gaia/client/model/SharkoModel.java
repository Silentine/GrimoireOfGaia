...
//
//		PartDefinition bodyback = bodymid.addOrReplaceChild("bodyback", CubeListBuilder.create().texOffs(32, 12).addBox(-7.0F, -8.0F, -4.0F, 14.0F, 8.0F, 4.0F)
//				.texOffs(32, 0).addBox(-6.0F, -7.0F, -7.0F, 12.0F, 8.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -5.0F, 0.5F, 0.2618F, 0.0F, 0.0F));
//
