...
public class ModelGaiaGelatinousSlime<T extends MobEntity> extends ModelGaia<T> {
	...
	RendererModel invisiblearm;
	RendererModel rightarm;
	RendererModel leftarm;
	RendererModel rightarmlower;
	RendererModel rightleg;
	RendererModel leftleg;
	RendererModel leftleglower;
	RendererModel mainbody1;
	RendererModel mainbody2;
	RendererModel mainbody2particles;
	RendererModel slime1;
	RendererModel slime2;
	RendererModel slime3;
	RendererModel slimesoutheast;
	RendererModel slimenortheast;
	RendererModel slimenorthwest;
	RendererModel slimesouthwest;
	...
	public ModelGaiaGelatinousSlime() {
		...
		bodyupper = new RendererModel(this, 0, 16);
		...
		invisiblearm = new RendererModel(this, 32, 16);
		invisiblearm.addBox(-1F, 0F, -1F, 2, 12, 2);
		invisiblearm.setRotationPoint(-2F, 4F, 8F);
		invisiblearm.setTextureSize(64, 32);
		...
		rightarmlower = new RendererModel(this, 24, 16);
		...
		mainbody1 = new RendererModel(this, 64, 0);
		...
		mainbody2 = new RendererModel(this, 64, 64);
...
//	    mainbody2ParticleTypes.render(scale);
		slime1.render(scale);
		slime2.render(scale);
		slime3.render(scale);
