...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaValkyrie<T extends MobEntity> extends ModelGaia<T> {
	...
	private RendererModel cape3;
	private RendererModel skirtmantle;
	...
	public ModelGaiaValkyrie() {
		...
		RendererModel rightfeather = new RendererModel(this, 36, 37);
		...
		RendererModel leftfeather = new RendererModel(this, 36, 37);
		...
		RendererModel headhelmet = new RendererModel(this, 36, 51);
		...
		cape1 = new RendererModel(this, 64, 0);
		...
		RendererModel rightpauldron = new RendererModel(this, 64, 23);
		...
		RendererModel leftpauldron = new RendererModel(this, 80, 23);
		...
		RendererModel rightgauntlet = new RendererModel(this, 64, 30);
		...
		skirtmantle = new RendererModel(this, 96, 0);
		...
		skirt1 = new RendererModel(this, 96, 8);
		...
		skirt2 = new RendererModel(this, 96, 16);
		...
		skirt3 = new RendererModel(this, 96, 25);
		...
		rightwing = new RendererModel(this, 74, 34);
