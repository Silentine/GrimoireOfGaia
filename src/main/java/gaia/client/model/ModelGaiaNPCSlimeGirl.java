...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaNPCSlimeGirl<T extends MobEntity> extends ModelGaia<T> {
	...
	public ModelGaiaNPCSlimeGirl() {
		...
		RendererModel headslime = new RendererModel(this, 36, 14);
		...
		RendererModel lefthair = new RendererModel(this, 36, 50);
