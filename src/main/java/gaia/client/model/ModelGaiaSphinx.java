...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaSphinx<T extends MobEntity> extends ModelGaia<T> {
	...
	private RendererModel rightarm3;
	private RendererModel leftarm3;
	private RendererModel body2;
	private RendererModel body3;
	private RendererModel tail;
	private RendererModel rightbackleg1;
	private RendererModel leftbackleg1;
	...
	public ModelGaiaSphinx() {
		...
		leftchest = new RendererModel(this, 0, 25);
		...
		RendererModel rightarm1 = new RendererModel(this, 18, 12);
		...
		RendererModel leftarm1 = new RendererModel(this, 18, 12);
		...
		RendererModel rightear = new RendererModel(this, 36, 14);
		...
		RendererModel leftear = new RendererModel(this, 48, 14);
		...
		rightarm3 = new RendererModel(this, 18, 32);
		...
		leftarm3 = new RendererModel(this, 18, 32);
		...
		RendererModel rightarmbracelet = new RendererModel(this, 36, 37);
		...
		RendererModel leftarmbracelet = new RendererModel(this, 36, 37);
		...
		leftbackleg1 = new RendererModel(this, 96, 0);
		...
		RendererModel rightbackleg2 = new RendererModel(this, 96, 14);
		...
		RendererModel leftbackleg2 = new RendererModel(this, 96, 14);
		...
		RendererModel rightbackleg3 = new RendererModel(this, 96, 23);
		...
		RendererModel leftbackleg3 = new RendererModel(this, 96, 23);
		...
		RendererModel rightbacklegbracelet = new RendererModel(this, 36, 37);
		...
		RendererModel leftbacklegbracelet = new RendererModel(this, 36, 37);
		...
		RendererModel rightbackleg4 = new RendererModel(this, 96, 32);
		...
		RendererModel leftbackleg4 = new RendererModel(this, 96, 32);
		...
		rightwing = new RendererModel(this, 92, 36);
		...
		leftwing = new RendererModel(this, 104, 36);
