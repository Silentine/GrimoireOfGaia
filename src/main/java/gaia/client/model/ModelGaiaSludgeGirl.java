...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaSludgeGirl<T extends MobEntity> extends ModelGaia<T> {
	...
	private RendererModel headtop1;
	private RendererModel headslime1;
	private RendererModel headslime2;
	...
	public ModelGaiaSludgeGirl() {
		...
		headtop1 = new RendererModel(this, 72, -6);
		...
		RendererModel headtop2 = new RendererModel(this, 72, 7);
		...
		headslime1 = new RendererModel(this, 36, 32);
		...
		headslime2 = new RendererModel(this, 36, 46);
		...
		RendererModel righteye = new RendererModel(this, 84, 0);
