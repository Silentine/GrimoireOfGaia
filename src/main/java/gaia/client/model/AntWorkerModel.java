...
public class AntWorkerModel extends EntityModel<AntWorker> implements HeadedModel, ArmedModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hairahoge = head.addOrReplaceChild("hairahoge", CubeListBuilder.create().texOffs(36, 14).addBox(0.0F, -4.0F, -4.0F, 4.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -6.0F, 0.0F, 0.0F, 0.7854F, 0.0F));
		...
		PartDefinition headrighthair = head.addOrReplaceChild("headrighthair", CubeListBuilder.create().texOffs(36, 22).addBox(-4.0F, -7.0F, 2.0F, 2.0F, 2.0F, 2.0F)
		...
		PartDefinition headlefthair = head.addOrReplaceChild("headlefthair", CubeListBuilder.create().texOffs(36, 22).addBox(2.0F, -7.0F, 2.0F, 2.0F, 2.0F, 2.0F)
		...
		PartDefinition rightgauntlet_r1 = rightarmlower.addOrReplaceChild("rightgauntlet_r1", CubeListBuilder.create().texOffs(64, 0).addBox(-1.0F, -6.0F, -1.5F, 2.0F, 6.0F, 3.0F), PartPose.offsetAndRotation(-1.005F, 5.0F, -1.0F, 0.0F, 0.0F, -0.1745F));
		...
		PartDefinition leftgauntlet_r1 = leftarmlower.addOrReplaceChild("leftgauntlet_r1", CubeListBuilder.create().texOffs(64, 0).mirror().addBox(-1.0F, -6.0F, -1.5F, 2.0F, 6.0F, 3.0F).mirror(false), PartPose.offsetAndRotation(1.005F, 5.0F, -1.0F, 0.0F, 0.0F, 0.1745F));
		...
		PartDefinition rightarm2lower = rightarm2.addOrReplaceChild("rightarm2lower", CubeListBuilder.create().texOffs(64, 17).addBox(-0.505F, 0.0F, -1.0F, 1.0F, 3.0F, 1.0F), PartPose.offsetAndRotation(0.0F, 2.5F, 0.5F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition leftarm2lower = leftarm2.addOrReplaceChild("leftarm2lower", CubeListBuilder.create().texOffs(64, 17).mirror().addBox(-0.495F, 0.0F, -1.0F, 1.0F, 3.0F, 1.0F).mirror(false), PartPose.offsetAndRotation(0.0F, 2.5F, 0.5F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition thorax3 = thorax2.addOrReplaceChild("thorax3", CubeListBuilder.create().texOffs(64, 34).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 2.0F, 2.0F), PartPose.offset(0.0F, 4.0F, -1.0F));
		...
		PartDefinition rightlegknee_r1 = rightlegknee.addOrReplaceChild("rightlegknee_r1", CubeListBuilder.create().texOffs(80, 0).addBox(-4.005F, 0.0F, 7.0F, 2.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(3.0F, 8.0F, 0.0F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition rightlegfoot = rightleglower.addOrReplaceChild("rightlegfoot", CubeListBuilder.create().texOffs(80, 14).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(1.0F, 6.0F, -1.0F, 0.2618F, 0.0F, -0.1745F));
		...
		PartDefinition leftlegknee_r1 = leftlegknee.addOrReplaceChild("leftlegknee_r1", CubeListBuilder.create().texOffs(80, 0).addBox(1.995F, 0.0F, 7.0F, 2.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(-3.0F, 8.0F, 0.0F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition leftlegfoot = leftleglower.addOrReplaceChild("leftlegfoot", CubeListBuilder.create().texOffs(80, 14).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(-1.0F, 6.0F, -1.0F, 0.2618F, 0.0F, 0.1745F));
