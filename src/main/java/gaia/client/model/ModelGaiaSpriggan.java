...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaSpriggan<T extends MobEntity> extends ModelGaia<T> {
	...
	public ModelGaiaSpriggan() {
		...
		RendererModel headhorns = new RendererModel(this, 36, 14);
		...
		RendererModel headhornslong1 = new RendererModel(this, 36, 30);
		...
		RendererModel headhornslong2 = new RendererModel(this, 36, 40);
		...
		RendererModel leftarmlower = new RendererModel(this, 82, 8);
		...
		spine = new RendererModel(this, 82, 18);
		...
		RendererModel rightleglower = new RendererModel(this, 110, 0);
		...
		RendererModel leftleglower = new RendererModel(this, 110, 0);
