...
public class ModelGaiaGryphon<T extends MobEntity> extends ModelGaia<T> {
	...
	public ModelGaiaGryphon() {
		...
		tail2 = new ModelRenderer(this, 56, 47);
		tail2.addBox(-0.5F, -0.5F, 0F, 1, 1, 6);
		tail2.setRotationPoint(0F, 8F, 16F);
		setRotation(tail2, 0F, 0F, 0F);
		tail3 = new ModelRenderer(this, 56, 54);
	...
	public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		...
		neck1.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
		neck2.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
		...
		frontrightleg1.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
		frontleftleg1.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
		backrightleg1.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
		backleftleg1.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
		tail1.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
	}
