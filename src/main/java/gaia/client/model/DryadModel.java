...
public class DryadModel extends EntityModel<DryadRenderState> implements HeadedModel, ArmedModel {
	...
	@Override
	public void setupAnim(DryadRenderState state) {
		super.setupAnim(state);

		this.headFlower.visible = !state.isBaby;
