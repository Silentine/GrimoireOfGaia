...
public class MandragoraModel extends EntityModel<MandragorarenderState> implements HeadedModel, ArmedModel {
	...
	@Override
	public void setupAnim(MandragorarenderState state) {
