...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaEnderDragonGirl<T extends MobEntity> extends ModelGaia<T> {
	...
	public ModelGaiaEnderDragonGirl() {
		...
		RendererModel righthorn = new RendererModel(this, 36, 14);
		...
		RendererModel lefthorn = new RendererModel(this, 36, 14);
		...
		RendererModel rightear = new RendererModel(this, 36, 19);
		...
		RendererModel leftear = new RendererModel(this, 36, 19);
		leftear.mirror = true;
		...
		RendererModel rightarmlower = new RendererModel(this, 16, 20);
		...
		RendererModel rightclaw = new RendererModel(this, 64, 0);
		...
		RendererModel leftclaw = new RendererModel(this, 74, 0);
		...
		waist = new RendererModel(this, 64, 6);
		...
		rightleg1 = new RendererModel(this, 86, 0);
		...
		leftleg1 = new RendererModel(this, 86, 0);
		...
		RendererModel rightleg2 = new RendererModel(this, 86, 14);
		...
		RendererModel leftleg2 = new RendererModel(this, 86, 14);
		...
		RendererModel rightleg3 = new RendererModel(this, 86, 26);
		...
		RendererModel leftleg3 = new RendererModel(this, 86, 26);
		...
		RendererModel rightleg4 = new RendererModel(this, 86, 33);
		...
		RendererModel leftleg4 = new RendererModel(this, 86, 33);
		...
		RendererModel rightleg5 = new RendererModel(this, 86, 41);
		...
		RendererModel leftleg5 = new RendererModel(this, 86, 41);
		...
		rightwing = new RendererModel(this, 104, 34);
		...
		leftwing = new RendererModel(this, 104, 34);
