...
@OnlyIn(Dist.CLIENT)
public class ModelGaiaSatyress<T extends MobEntity> extends ModelGaia<T> {
	...
	private RendererModel righthair;
	private RendererModel lefthair;
	...
	public ModelGaiaSatyress() {
		...
		righthair = new RendererModel(this, 36, 14);
		...
		lefthair = new RendererModel(this, 36, 14);
		...
		RendererModel righthorn1 = new RendererModel(this, 36, 30);
		...
		RendererModel righthorn2 = new RendererModel(this, 36, 34);
		...
		RendererModel righthorn3 = new RendererModel(this, 36, 39);
		...
		RendererModel righthorn4 = new RendererModel(this, 36, 44);
		...
		RendererModel lefthorn1 = new RendererModel(this, 36, 30);
		...
		RendererModel lefthorn2 = new RendererModel(this, 36, 34);
		...
		RendererModel lefthorn3 = new RendererModel(this, 36, 39);
		...
		RendererModel lefthorn4 = new RendererModel(this, 36, 44);
		...
		waist = new RendererModel(this, 64, 9);
		...
		RendererModel leftleglower = new RendererModel(this, 64, 23);
		...
		RendererModel rightfoot = new RendererModel(this, 64, 29);
		...
		RendererModel leftfoot = new RendererModel(this, 64, 29);
		...
		RendererModel rightfoothoof = new RendererModel(this, 64, 39);
		...
		RendererModel leftfoothoof = new RendererModel(this, 64, 39);
