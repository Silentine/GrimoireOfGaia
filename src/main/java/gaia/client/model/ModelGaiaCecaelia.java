...
public class ModelGaiaCecaelia<T extends MobEntity> extends ModelGaia<T> {
	...
	RendererModel righttentaclelower1;
	RendererModel righttentaclelower2;
	RendererModel lefttentaclelower1;
	RendererModel lefttentaclelower2;
	RendererModel tailbase;
	RendererModel tail1sw;
	RendererModel tail2sw;
	RendererModel tail3sw;
	RendererModel tail4sw;
	RendererModel tail1se;
	RendererModel tail2se;
	RendererModel tail3se;
	RendererModel tail4se;
	RendererModel tail1nw;
	RendererModel tail2nw;
	RendererModel tail3nw;
	RendererModel tail4nw;
	RendererModel tail1ne;
	RendererModel tail2ne;
	RendererModel tail3ne;
	RendererModel tail4ne;
	...
	public ModelGaiaCecaelia() {
		...
		RendererModel righteye = new RendererModel(this, 36, 14);
		...
		RendererModel lefteye = new RendererModel(this, 36, 14);
		lefteye.mirror = true;
		...
		RendererModel righttentacle1 = new RendererModel(this, 36, 20);
		...
		RendererModel righttentacle2 = new RendererModel(this, 36, 28);
		...
		RendererModel righttentacle3 = new RendererModel(this, 36, 34);
		...
		RendererModel lefttentacle1 = new RendererModel(this, 36, 20);
		...
		RendererModel lefttentacle2 = new RendererModel(this, 36, 28);
		...
		RendererModel lefttentacle3 = new RendererModel(this, 36, 34);
		...
		righttentaclelower1 = new RendererModel(this, 36, 38);
		...
		righttentaclelower2 = new RendererModel(this, 36, 47);
		...
		lefttentaclelower1 = new RendererModel(this, 36, 38);
		...
		lefttentaclelower2 = new RendererModel(this, 36, 47);
		...
		tailbase = new RendererModel(this, 64, 0);
		...
		tail4sw = new RendererModel(this, 64, 36);
		...
		tail4se = new RendererModel(this, 64, 36);
		tail4se.mirror = true;
		...
		tail4nw = new RendererModel(this, 64, 36);
		...
		tail4ne = new RendererModel(this, 64, 36);
		tail4ne.mirror = true;
