...
public class ItemSpawnCreeperGirl extends ItemBase {
	public ItemSpawnCreeperGirl() {
		super("spawn_creeper_girl");
		maxStackSize = 16;
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		tooltip.add(I18n.format("item.grimoireofgaia.spawn_creeper_girl.desc"));
	}
