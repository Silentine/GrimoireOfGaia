...
//	}
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		if (shiftPressed) {
			...
			tooltip.add(new TextComponentTranslation("text.grimoireofgaia.InventoryImmunity").appendSibling(new TextComponentString(" ")).appendSibling(new TextComponentTranslation("effect.minecraft.levitation")) );
