...
public class ItemWeaponBookHunger extends ItemWeaponBook {
	...
	public ItemWeaponBookHunger(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(new TextComponentTranslation("effect.minecraft.hunger").appendSibling(new TextComponentString(" (0:04)")));
	}
	...
	public boolean hitEntity(ItemStack stack, EntityLivingBase target, EntityLivingBase host) {
		...
		target.addPotionEffect(new PotionEffect(MobEffects.HUNGER, 80, 0));
		return true;
	}
}
