...
public class ItemAccessoryTrinketWither extends ItemAccessoryBauble {
	public ItemAccessoryTrinketWither(Item.Properties builder) {
		super(builder); //"accessory_trinket_wither");
	}
...
//	}
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		if (shiftPressed) {
			...
			tooltip.add(new TextComponentTranslation("text.grimoireofgaia.InventoryImmunity").appendSibling(new TextComponentString(" ")).appendSibling(new TextComponentTranslation("effect.minecraft.wither")));
			tooltip.add(new TextComponentTranslation("text.grimoireofgaia.InventoryImmunity").appendSibling(new TextComponentString(" ")).appendSibling(new TextComponentTranslation("effect.minecraft.regeneration")));
		} else {
