...
public class ItemWeaponBookNightmare extends ItemWeaponBook {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(new TextComponentTranslation("effect.minecraft.mining_fatique").appendSibling(new TextComponentString(" II")).appendSibling(new TextComponentString(" (0:04)")));
	}
