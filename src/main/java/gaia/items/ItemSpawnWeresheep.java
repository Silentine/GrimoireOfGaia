...
public class ItemSpawnWeresheep extends ItemBase {
	public ItemSpawnWeresheep() {
		super("spawn_weresheep");
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		tooltip.add(I18n.format("item.grimoireofgaia.spawn_weresheep.desc"));
	}
