...
public class ItemFoodPieAppleGold extends ItemFood {
	...
	public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
		...
		par3List.add(StatCollector.translateToLocal("potion.regeneration") + " (IV)" + " (0:20)");
		par3List.add(StatCollector.translateToLocal("potion.resistance") + " (5:00)");
		par3List.add(StatCollector.translateToLocal("potion.fireResistance") + " (5:00)");
	}
