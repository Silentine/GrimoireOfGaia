...
public class ModelGaiaBanshee extends ModelGaia {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		...
		this.rightarm.rotateAngleZ = MathHelper.cos(degToRad(entityIn.ticksExisted*7)) * degToRad(10);
		this.leftarm.rotateAngleZ = MathHelper.cos(degToRad(entityIn.ticksExisted*7)) * degToRad(-10);
