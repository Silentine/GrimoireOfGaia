...
public class ModelGaiaBanshee extends ModelBase {
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6) {
		...
		//body
		this.waist1.rotateAngleZ = MathHelper.cos(par1 * 0.6162F) * 0.1F * par2;
		this.waist2.rotateAngleZ = MathHelper.cos(par1 * 0.6262F) * 0.1F * par2;
		this.waist3.rotateAngleZ = MathHelper.cos(par1 * 0.6362F) * 0.1F * par2;
		this.waist4.rotateAngleZ = MathHelper.cos(par1 * 0.6462F) * 0.1F * par2;
	}
