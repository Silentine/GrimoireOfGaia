...
public class ModelGaiaHarpy extends ModelGaia {
	...
	public ModelGaiaHarpy() {
		...
		hairahoge.setTextureSize(128, 64);
		...
		righttalonupper.setTextureSize(128, 64);
		...
		lefttalonupper.setTextureSize(128, 64);
		...
		righttalon.setTextureSize(128, 64);
		...
		lefttalon.setTextureSize(128, 64);
		...
		righttalonlower.setTextureSize(128, 64);
		...
		lefttalonlower.setTextureSize(128, 64);
