...
public class ModelGaiaPropVaseNether extends ModelGaia {
	ModelRenderer top01;
	ModelRenderer top02;
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		EntityGaiaPropVaseNether entityGaiaPropVaseNether = (EntityGaiaPropVaseNether) entityIn;

		switch (entityGaiaPropVaseNether.getRotation()) {
		case 0:
