...
public class ModelGaiaCobbleGolem extends ModelGaia {
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
		...
		if (i > 0) {
			...
			if (j > 0) {
				this.rightarmupper.rotateAngleX = -0.8F + 0.025F * this.func_78172_a((float)j, 70.0F);
				this.leftarmupper.rotateAngleX = 0.0F;
			} else {
				this.rightarmupper.rotateAngleX = (-0.2F + 1.5F * this.func_78172_a(p_78086_2_, 13.0F)) * p_78086_3_;
				this.leftarmupper.rotateAngleX = (-0.2F - 1.5F * this.func_78172_a(p_78086_2_, 13.0F)) * p_78086_3_;
			}
		}
	}
