...
public class ModelGaiaEnderDragonGirl extends ModelGaia {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        rightleg1.rotateAngleY = 0.1745329F;
        leftleg1.rotateAngleY = -0.1745329F;
		...
		if (isRiding) {
			...
			rightleg1.rotateAngleX = -1.4137167F;
			rightleg1.rotateAngleY = ((float) Math.PI / 10F);
			rightleg1.rotateAngleZ = 0.07853982F;
			leftleg1.rotateAngleX = -1.4137167F;
			leftleg1.rotateAngleY = -((float) Math.PI / 10F);
			leftleg1.rotateAngleZ = -0.07853982F;
		}
	}
