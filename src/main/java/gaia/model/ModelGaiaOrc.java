...
public class ModelGaiaOrc extends ModelGaia {
	...
	public ModelGaiaOrc() {
		...
		ModelRenderer rightarmpauldron = new ModelRenderer(this, 100, 6);
		...
		ModelRenderer leftarmpauldron = new ModelRenderer(this, 100, 6);
		...
		ModelRenderer rightarmhorn = new ModelRenderer(this, 100, 0);
		...
		ModelRenderer leftarmhorn = new ModelRenderer(this, 100, 0);
		...
		ModelRenderer rightarmgauntlet = new ModelRenderer(this, 100, 16);
		...
		ModelRenderer leftarmgauntlet = new ModelRenderer(this, 100, 16);
		...
		ModelRenderer rightlegupper = new ModelRenderer(this, 100, 26);
		...
		ModelRenderer leftlegupper = new ModelRenderer(this, 100, 26);
		...
		ModelRenderer rightlegboot = new ModelRenderer(this, 100, 36);
		...
		ModelRenderer leftlegboot = new ModelRenderer(this, 100, 36);
