...
public class ModelGaiaWerecat extends ModelGaia {
	...
	public ModelGaiaWerecat() {
		...
		rightear.addBox(-4.5F, -10F, -1.5F, 4, 4, 3);
		rightear.setRotationPoint(0F, 1F, -2.5F);
		rightear.setTextureSize(128, 64);
		setRotation(rightear, 0F, 0F, 0F);
		ModelRenderer leftear = new ModelRenderer(this, 50, 28);
		leftear.addBox(0.5F, -10F, -1.5F, 4, 4, 3);
		leftear.setRotationPoint(0F, 1F, -2.5F);
