...
public class ModelGaiaAnubis extends ModelGaia {
    ...
    public ModelGaiaAnubis() {
        ...
        rightarmlower = new ModelRenderer(this, 64, 0);
        ...
        leftarmlower = new ModelRenderer(this, 74, 0);
        ...
        rightarmhand = new ModelRenderer(this, 64, 11);
        ...
        leftarmhand = new ModelRenderer(this, 76, 11);
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        // rightarmhand.render(scale);
        // leftarmhand.render(scale);
    ...
    public void spawnAnimation(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if ((rightarm.rotateAngleX == -1.047198F) && (leftarm.rotateAngleX == -1.047198F)) {
