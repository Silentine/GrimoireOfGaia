...
public class ModelGaiaNPCCreeperGirl extends ModelGaia {
    ...
    public ModelGaiaNPCCreeperGirl() {
        ...
        this.waist1 = new ModelRenderer(this, 36, 22);
        this.waist1.addBox(-3.5F, 7.5F, -3F, 7, 3, 4);
        this.waist1.setRotationPoint(0F, 1F, 0F);
        this.waist1.setTextureSize(128, 64);
        this.setRotation(waist1, 0.0872665F, 0F, 0F);
        this.waist2 = new ModelRenderer(this, 36, 29);
        this.waist2.addBox(-4F, 8.5F, -3.5F, 8, 3, 5);
