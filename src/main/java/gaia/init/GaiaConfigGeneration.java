...
public class GaiaConfigGeneration extends GaiaConfig {
	...
	public static void syncConfig() {
		...
		//Base Defense
		Tier1baseDefense = config.get("defense", "configgui.GrimoireOfGaia.category.defense.Tier1baseDefense", Tier1baseDefense).getInt();
		Tier2baseDefense = config.get("defense", "configgui.GrimoireOfGaia.category.defense.Tier2baseDefense", Tier2baseDefense).getInt();
		Tier3baseDefense = config.get("defense", "configgui.GrimoireOfGaia.category.defense.Tier3baseDefense", Tier3baseDefense).getInt();
