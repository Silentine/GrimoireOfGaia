...
public class GaiaConfigGeneration {
	...
	public static void syncConfig(){
		...
		ConfigGaia.StrafingArchers = config.get("base damage", "configgui.GrimoireOfGaia.category.damage.StrafingArchers", true).getBoolean(true);
		//Attributes
		...
		ConfigGaia.OreUnity = config.get("debug", "configgui.GrimoireOfGaia.category.debug.Ore_Unity", true).getBoolean(true);
