...
public class GaiaEntity {
	...
	public static void register() {		
		...
		Register(EntityGaiaGryphon.class, 			"Gryphon", 			22, 0xf09942, 0xe2e2e2);
		Register(EntityGaiaHarpy.class, 			"Harpy", 			23, 0xc9b161, 0xa5884e);
		Register(EntityGaiaHunter.class, 			"Hunter", 			24, 0xae6b3c, 0x353535);
		Register(EntityGaiaKobold.class, 			"Kobold", 			25, 0x938dab, 0xafa7c1);
		Register(EntityGaiaMatango.class, 			"Matango", 			26, 0xab1311, 0xd8d8d8);
		Register(EntityGaiaMermaid.class, 			"Mermaid", 			27, 0x5c70b1, 0xa4452d);
		Register(EntityGaiaMinotaur.class, 			"Minotaur", 		28, 0x8d4f41, 0xd54242);
		Register(EntityGaiaMinotaurus.class,		"Minotaurus", 		29, 0x8d4f41, 0xa9a9a9);
		Register(EntityGaiaMummy.class, 			"Mummy", 			30, 0xdcd7c1, 0xc9b161);
		Register(EntityGaiaNaga.class, 				"Naga", 			31, 0x29bc55, 0xccb63f);		
		Register(EntityGaiaNineTails.class, 		"NineTails", 		32, 11809844, 13218145);
		Register(EntityGaiaSahuagin.class, 			"Sahuagin", 		33, 0x5c70b1, 0x84a498);		
		Register(EntityGaiaSatyress.class, 			"Satyress", 		34, 0x707b4f, 0xa4452d);
		Register(EntityGaiaSelkie.class, 			"Selkie", 			35, 9082818, 13488612);
		Register(EntityGaiaShaman.class, 			"Shaman", 			36, 0xae6b3c, 0x56b134);
		Register(EntityGaiaSharko.class, 			"Sharko", 			37, 0x84a498, 0x5c70b1);		
		Register(EntityGaiaSiren.class, 			"Siren", 			38, 0x29bc55, 0x48a0de);
		Register(EntityGaiaSludgeGirl.class, 		"SludgeGirl", 		39, 6595667, 7715172);
		Register(EntityGaiaSphinx.class, 			"Sphinx", 			40, 0xf09942, 0x353535);
		Register(EntityGaiaSpriggan.class, 			"Spriggan", 		41, 0x7c623e, 0xc2dda5);
		Register(EntityGaiaSuccubus.class, 			"Succubus", 		42, 4079166, 13218145);
		Register(EntityGaiaToad.class, 				"Toad", 			43, 0x355d2b, 0x779f5a);
		Register(EntityGaiaValkyrie.class, 			"Valkyrie", 		44, 0xc9b161, 0xd54242);
		Register(EntityGaiaVampire.class, 			"Vampire", 			45, 0xc23021, 0xc9b161);		
		Register(EntityGaiaWerecat.class, 			"Werecat", 			46, 0x7a7e8a, 0xdddadb);		
		Register(EntityGaiaWitch.class, 			"Witch", 			47, 0x303030, 0x943dbb);
		...
		/*Items
		Register(EntityGaiaBoxDiamond.class,		"BoxDiamond"		, 201 );
		Register(EntityGaiaBoxGold.class, 			"BoxGold"			, 202 );
		Register(EntityGaiaBoxIron.class, 			"BoxIron"			, 203 );
		Register(EntityGaiaChest.class, 			"ChestDunegon"		, 204 );
		Register(EntityGaiaChestJungle.class, 		"ChestJungle"		, 205 );
		 */
