...
import gaia.items.ItemBoxOverworld;
...
public class GaiaItems {
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		...
		FOOD_MEAT = registerItem(new ItemFoodBase(itemBuilder(), 6, 1.2F, true), "food_meat");
		...
		MISC_FUR = registerItem(new ItemBase(itemBuilder()), "misc_fur");
		...
		MISC_QUILL = registerItem(new ItemBase(itemBuilder()), "misc_quill");
		...
		SPAWN_WERESHEEP = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, GaiaEntities.WERESHEEP_NPC), "spawn_weresheep");
		SPAWN_CREEPER_GIRL = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, GaiaEntities.CREEPER_GIRL_NPC), "spawn_creeper_girl");
		SPAWN_ENDER_GIRL = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, GaiaEntities.ENDER_GIRL_NPC), "spawn_ender_girl");
		SPAWN_HOLSTAURUS = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, GaiaEntities.HOLSTAURUS_NPC), "spawn_holstaurus");
		SPAWN_SLIME_GIRL = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, GaiaEntities.SLUDGE_GIRL_NPC), "spawn_slime_girl");
		SPAWN_TAME = registerItem(new ItemSpawnTame(itemBuilder()), "spawn_tame");
		SPAWN_TRADER = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, GaiaEntities.TRADER_NPC), "spawn_trader");
		WEAPON_BOOK = registerItem(new ItemWeaponBook(EnumGaiaTier.BOOK, 3, -2.4F, itemBuilder()), "weapon_book");
		WEAPON_BOOK_BATTLE = registerItem(new ItemWeaponBookBattle(EnumGaiaTier.BOOK, 3, -2.4F, itemBuilder()), "weapon_book_battle");
		WEAPON_BOOK_ENDER = registerItem(new ItemWeaponBookEnder(EnumGaiaTier.BOOK, 3, -2.4F, itemBuilder()), "weapon_book_ender");
		WEAPON_BOOK_FREEZING = registerItem(new ItemWeaponBookFreezing(EnumGaiaTier.BOOK, 3, -2.4F, itemBuilder()), "weapon_book_freezing");
		WEAPON_BOOK_HUNGER = registerItem(new ItemWeaponBookHunger(EnumGaiaTier.BOOK, 3, -2.4F, itemBuilder()), "weapon_book_hunger");
		WEAPON_BOOK_METAL = registerItem(new ItemWeaponBookMetal(EnumGaiaTier.BOOK, 3, -2.4F, itemBuilder()), "weapon_book_metal");
		WEAPON_BOOK_NATURE = registerItem(new ItemWeaponBookNature(EnumGaiaTier.BOOK, 3, -2.4F, itemBuilder()), "weapon_book_nature");
		WEAPON_BOOK_NIGHTMARE = registerItem(new ItemWeaponBookNightmare(EnumGaiaTier.BOOK, 3, -2.4F, itemBuilder()), "weapon_book_nightmare");
		WEAPON_BOOK_WITHER = registerItem(new ItemWeaponBookWither(EnumGaiaTier.BOOK, 3, -2.4F, itemBuilder()), "weapon_book_wither");
		...
		WEAPON_PROP_SWORD_WOOD = registerItem(new ItemWeaponPropItemSword(EnumGaiaTier.PROP, 3, -2.4F, itemBuilder()), "weapon_prop_sword_wood");
		WEAPON_PROP_SWORD_STONE = registerItem(new ItemWeaponPropItemSword(EnumGaiaTier.PROP, 3, -2.4F, itemBuilder()), "weapon_prop_sword_stone");
		WEAPON_PROP_SWORD_IRON = registerItem(new ItemWeaponPropItemSword(EnumGaiaTier.PROP, 3, -2.4F, itemBuilder()), "weapon_prop_sword_iron");
		WEAPON_PROP_SWORD_GOLD = registerItem(new ItemWeaponPropItemSword(EnumGaiaTier.PROP, 3, -2.4F, itemBuilder()), "weapon_prop_sword_gold");
		WEAPON_PROP_AXE_WOOD = registerItem(new ItemWeaponPropItemSword(EnumGaiaTier.PROP, 3, -2.4F, itemBuilder()), "weapon_prop_axe_wood");
		WEAPON_PROP_AXE_STONE = registerItem(new ItemWeaponPropItemSword(EnumGaiaTier.PROP, 3, -2.4F, itemBuilder()), "weapon_prop_axe_stone");
		WEAPON_PROP_AXE_IRON = registerItem(new ItemWeaponPropItemSword(EnumGaiaTier.PROP, 3, -2.4F, itemBuilder()), "weapon_prop_axe_iron");
		WEAPON_PROP_AXE_GOLD = registerItem(new ItemWeaponPropItemSword(EnumGaiaTier.PROP, 3, -2.4F, itemBuilder()), "weapon_prop_axe_gold");
		WEAPON_PROP_DAGGER_METAL = registerItem(new ItemWeaponPropItemSword(EnumGaiaTier.PROP, 3, -2.4F, itemBuilder()), "weapon_prop_dagger_metal");
		WEAPON_PROP_BROOM = registerItem(new ItemWeaponPropItemSword(EnumGaiaTier.PROP, 3, -2.4F, itemBuilder()), "weapon_prop_broom");
		WEAPON_PROP_HAMMER_MINOTAUR = registerItem(new ItemWeaponPropItemSword(EnumGaiaTier.PROP, 3, -2.4F, itemBuilder()), "weapon_prop_hammer_minotaur");

		ANT_SPAWN_EGG = registerItem(new ItemGaiaSpawnEgg(GaiaEntities.DEBUG_MOB, 0x6fa289, 0x915741, itemBuilder()), "debug_mob_spawn_egg");
