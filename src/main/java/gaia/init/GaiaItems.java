...
public class GaiaItems {
	...
	public static class RegistrationHandler {
		...
		public static void registerItems(final RegistryEvent.Register<Item> event) {
			...
			registry.register(new ItemAccessoryRing());
			registry.register(new ItemMiscFurnaceFuel());
			registry.register(new ItemMiscCurrency());
			registry.register(new ItemSpawn());
			registry.register(new ItemSpawnCreeperGirl());
			registry.register(new ItemSpawnSlimeGirl());
			registry.register(new ItemSpawnEnderGirl());
			registry.register(new ItemSpawnTrader());
			registry.register(new ItemSpawnHolstaurus());
			registry.register(new ItemSpawnWeresheep());
