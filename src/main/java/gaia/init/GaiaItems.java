...
public class GaiaItems {
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		...
		SPAWN_WERESHEEP = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, EntityGaiaNPCWeresheep::new), "spawn_weresheep");
		SPAWN_CREEPER_GIRL = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, EntityGaiaNPCCreeperGirl::new), "spawn_creeper_girl");
		SPAWN_ENDER_GIRL = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, EntityGaiaNPCEnderGirl::new), "spawn_ender_girl");
		SPAWN_HOLSTAURUS = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, EntityGaiaNPCHolstaurus::new), "spawn_holstaurus");
		SPAWN_SLIME_GIRL = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, EntityGaiaNPCSlimeGirl::new), "spawn_slime_girl");
		SPAWN_TAME = registerItem(new ItemSpawnTame(itemBuilder()), "spawn_tame");
		SPAWN_TRADER = registerItem(new ItemSpawnNPC(itemBuilder(), EnumRarity.RARE, EntityGaiaNPCTrader::new), "spawn_trader");
