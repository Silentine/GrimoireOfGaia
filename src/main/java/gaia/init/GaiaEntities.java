...
//	public static final RegistryObject<EntityType<EntityDebugMob>> DEBUG_MOB = ENTITIES.register("debug_mob", () -> register("debug_mob", EntityType.Builder.create(EntityDebugMob::new, EntityDebugMob::new));
	...
	public static final RegistryObject<EntityType<GaiaCecaeliaEntity>> CECAELIA = ENTITIES.register("cecaelia", () -> register("cecaelia", EntityType.Builder.<GaiaCecaeliaEntity>create(GaiaCecaeliaEntity::new, EntityClassification.MONSTER)));
