...
public class RenderGaiaAnubis extends RenderLiving<EntityGaiaAnubis> {

	private static final ResourceLocation texture = new ResourceLocation("gaia", "textures/models/Anubis.png");

	public RenderGaiaAnubis(RenderManager renderManager, ModelGaiaAnubis model, float shadowSize) {
	...
	protected ResourceLocation getEntityTexture(EntityGaiaAnubis entity) {
		return texture;
	}
}
