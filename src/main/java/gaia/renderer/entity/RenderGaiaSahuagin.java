...
public class RenderGaiaSahuagin extends RenderLiving<EntityLiving> {
    ...
    public RenderGaiaSahuagin(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelGaiaSahuagin(), GaiaReference.SMALL_SHADOW);
    ...
    public static class Factory implements IRenderFactory<EntityLiving> {
	    ...
	    public Render<? super EntityLiving> createRenderFor(RenderManager manager) {
	      return new RenderGaiaSahuagin(manager);
	    }
    }
}
