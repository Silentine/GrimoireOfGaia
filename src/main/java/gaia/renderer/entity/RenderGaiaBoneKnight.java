...
public class RenderGaiaBoneKnight extends RenderLiving<EntityLiving> {
    ...
    public RenderGaiaBoneKnight(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelGaiaBoneKnight(), GaiaReference.MEDIUM_SHADOW);
    ...
    public static class Factory implements IRenderFactory<EntityLiving> {
	    ...
	    public Render<? super EntityLiving> createRenderFor(RenderManager manager) {
	      return new RenderGaiaBoneKnight(manager);
	    }
    }
}
