...
public class RenderGaiaDullahan extends RenderLiving<EntityLiving> {
    ...
    public RenderGaiaDullahan(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelGaiaDullahan(), GaiaReference.SMALL_SHADOW);
    ...
    public static class Factory implements IRenderFactory<EntityLiving> {
	    ...
	    public Render<? super EntityLiving> createRenderFor(RenderManager manager) {
	      return new RenderGaiaDullahan(manager);
	    }
    }
}
