...
public class RenderGaiaMermaid extends RenderLiving<EntityLiving> {
    ...
    public RenderGaiaMermaid(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelGaiaMermaid(), GaiaReference.SMALL_SHADOW);
    ...
    public static class Factory implements IRenderFactory<EntityLiving> {
	    ...
	    public Render<? super EntityLiving> createRenderFor(RenderManager manager) {
	      return new RenderGaiaMermaid(manager);
	    }
    }
}
