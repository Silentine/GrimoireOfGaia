...
public class RenderGaiaAnubis extends RenderLiving<EntityLiving> {
    ...
    public RenderGaiaAnubis(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelGaiaAnubis(), GaiaReference.SMALL_SHADOW);
    ...
    public static class Factory implements IRenderFactory<EntityLiving> {
	    ...
	    public Render<? super EntityLiving> createRenderFor(RenderManager manager) {
	      return new RenderGaiaAnubis(manager);
	    }
    }
}
