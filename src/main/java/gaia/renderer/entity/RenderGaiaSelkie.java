...
public class RenderGaiaSelkie extends RenderLiving<EntityLiving> {
    ...
    public RenderGaiaSelkie(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelGaiaSelkie(), GaiaReference.SMALL_SHADOW);
    ...
    public static class Factory implements IRenderFactory<EntityLiving> {
	    ...
	    public Render<? super EntityLiving> createRenderFor(RenderManager manager) {
	      return new RenderGaiaSelkie(manager);
	    }
    }
}
