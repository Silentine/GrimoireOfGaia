...
public class LayerAuraSphinx implements LayerRenderer<EntityGaiaSphinx> {
	...
	private final RenderGaiaSphinx entityRenderer;
	private final ModelGaiaSphinx entityModel = new ModelGaiaSphinx(0.5F);

	public LayerAuraSphinx(RenderGaiaSphinx entityRendererIn) {
		this.entityRenderer = entityRendererIn;
	}

	public void doRenderLayer(EntityGaiaSphinx entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
