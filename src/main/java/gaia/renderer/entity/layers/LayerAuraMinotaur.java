...
public class LayerAuraMinotaur implements LayerRenderer<EntityGaiaMinotaur> {
	...
	private final RenderGaiaMinotaur entityRenderer;
	private final ModelGaiaMinotaur entityModel = new ModelGaiaMinotaur(0.5F);

	public LayerAuraMinotaur(RenderGaiaMinotaur entityRendererIn) {
