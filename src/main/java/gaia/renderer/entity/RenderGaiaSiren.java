...
public class RenderGaiaSiren extends RenderLiving<EntityLiving> {
    ...
    public RenderGaiaSiren(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelGaiaSiren(), GaiaReference.SMALL_SHADOW);
    ...
    public static class Factory implements IRenderFactory<EntityLiving> {
	    ...
	    public Render<? super EntityLiving> createRenderFor(RenderManager manager) {
	      return new RenderGaiaSiren(manager);
	    }
    }
}
