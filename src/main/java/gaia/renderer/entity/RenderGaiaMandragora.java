...
public class RenderGaiaMandragora extends RenderLiving<EntityLiving> {
    ...
    public RenderGaiaMandragora(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelGaiaMandragora(), GaiaReference.TINY_SHADOW);
    ...
    public static class Factory implements IRenderFactory<EntityLiving> {
	    ...
	    public Render<? super EntityLiving> createRenderFor(RenderManager manager) {
	      return new RenderGaiaMandragora(manager);
	    }
    }
}
