...
public class RenderGaiaWitch extends RenderLiving<EntityLiving> {
    ...
    public static class LayerGaiaWitchHeldItem implements LayerRenderer<EntityLivingBase> {
        ...
        public LayerGaiaWitchHeldItem(RenderLiving<EntityLiving> livingEntityRendererIn, ModelRenderer limb, EntityEquipmentSlot slot) {
            this.livingEntityRenderer = livingEntityRendererIn;
            this.limb = limb;
            this.slot = slot;
        }

        public LayerGaiaWitchHeldItem Left(RenderLiving<EntityLiving> livingEntityRendererIn, ModelRenderer limb) {
