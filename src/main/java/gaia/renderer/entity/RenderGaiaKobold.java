...
public class RenderGaiaKobold extends RenderLiving<EntityLiving> {
    ...
    public RenderGaiaKobold(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelGaiaKobold(), GaiaReference.SMALL_SHADOW);
    ...
    public static class Factory implements IRenderFactory<EntityLiving> {
	    ...
	    public Render<? super EntityLiving> createRenderFor(RenderManager manager) {
	      return new RenderGaiaKobold(manager);
	    }
    }
}
