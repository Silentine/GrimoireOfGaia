...
public class TileRenderBustValkyrie extends TileEntitySpecialRenderer<TileEntity> {
    ...
    public void renderModel(TileEntityBustValkyrie te, double d, double d1, double d2, float f) {
        this.texture = new ResourceLocation(GaiaReference.MOD_ID, "textures/models/blocks/bustvalkyrie.png");
