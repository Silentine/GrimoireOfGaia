...
{
	private final ResourceLocation TextureLocation = ParticleHandler.BubbleLocation;
	
	/**
	 * Construct a new FlameParticle at the given [x,y,z] position with the given initial velocity.
	 */
	public ExampleParticle(World world, double x, double y, double z, double velocityX, double velocityY, double velocityZ){
