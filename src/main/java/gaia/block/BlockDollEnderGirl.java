...
public class BlockDollEnderGirl extends BlockContainer {
    ...
    public BlockDollEnderGirl() {
        ...
        this.setRegistryName(new ResourceLocation(GaiaReference.MOD_ID, GaiaBlocks.DOLL_ENDER_GIRL_NAME));
        this.setUnlocalizedName(GaiaReference.MOD_PREFIX + GaiaBlocks.DOLL_ENDER_GIRL_NAME);
