...
public class BlockBustVampire extends BlockContainer {
    ...
    public BlockBustVampire() {
        ...
        this.setRegistryName(new ResourceLocation(GaiaReference.MOD_ID, GaiaBlocks.BUST_VAMPIRE_NAME));
        this.setUnlocalizedName(GaiaReference.MOD_PREFIX + GaiaBlocks.BUST_VAMPIRE_NAME);
