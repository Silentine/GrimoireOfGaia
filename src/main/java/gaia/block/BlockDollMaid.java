...
public class BlockDollMaid extends BlockContainer {
    ...
    public BlockDollMaid() {
        super(Material.CLOTH);
        this.setLightOpacity(0);
        this.setHardness(3.0F);
        this.setResistance(6.0F);
        this.setRegistryName(new ResourceLocation(GaiaReference.MOD_ID, GaiaBlocks.DOLL_MAID_NAME));
        this.setUnlocalizedName(GaiaReference.MOD_PREFIX + GaiaBlocks.DOLL_MAID_NAME);
