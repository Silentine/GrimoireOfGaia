...
public class GaiaRegistry {
	...
	public static final MobReg<Behender> BEHENDER = new MobReg.Builder<>("behender", GaiaMobType.ASSIST, EntityType.Builder.of(Behender::new, MobCategory.MONSTER).sized(1.5F, 1.6F).clientTrackingRange(8), 0x2f5754, 0x82ba74).withDefaultSounds().build();
	...
	public static final MobReg<Valkyrie> VALKYRIE = new MobReg.Builder<>("valkyrie", EntityType.Builder.of(Valkyrie::new, MobCategory.MONSTER).sized(1.0F, 2.0F).clientTrackingRange(8), 0xc9b161, 0xd54242).withDefaultSounds().build();
