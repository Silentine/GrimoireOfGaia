...
//	public static final MobReg<Weresheep> WERESHEEP = new MobReg.Builder<>("weresheep", GaiaMobType.PASSIVE, EntityType.Builder.of(Weresheep::new, MobCategory.CREATURE).sized(0.6F, 1.99F).clientTrackingRange(8)).traderEgg().withDefaultSounds().build();
	...
	public static final DeferredItem<Item> TAPROOT = ITEMS.registerSimpleItem("taproot", (properties) -> properties.food(GaiaFoods.TAPROOT, GaiaFoods.TAPROOT_CONSUMABLE));
	public static final DeferredItem<SummonStaffItem> ZOMBIE_STAFF = ITEMS.registerItem("zombie_staff", (properties) -> new SummonStaffItem(properties.rarity(Rarity.RARE).durability(10), () -> EntityTypes.ZOMBIE, Items.ROTTEN_FLESH));
	public static final DeferredItem<SummonStaffItem> SKELETON_STAFF = ITEMS.registerItem("skeleton_staff", (properties) -> new SummonStaffItem(properties.rarity(Rarity.RARE).durability(10), () -> EntityTypes.SKELETON, Items.BONE));
	public static final DeferredItem<SummonStaffItem> CAVE_SPIDER_STAFF = ITEMS.registerItem("cave_spider_staff", (properties) -> new SummonStaffItem(properties.rarity(Rarity.RARE).durability(10), () -> EntityTypes.CAVE_SPIDER, Items.SPIDER_EYE));
