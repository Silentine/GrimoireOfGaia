...
public class GaiaRegistry {
	...
	public static final MobReg<AntSalvager> ANT_SALVAGER = new MobReg.Builder<>("ant_salvager", EntityType.Builder.<AntSalvager>of(AntSalvager::new, MobCategory.MONSTER).sized(0.5F, 1.99F).clientTrackingRange(8), 0x8a7264, 0x303030).withDefaultSounds().build();
	...
	public static final MobReg<Bee> BEE = new MobReg.Builder<>("bee", EntityType.Builder.<Bee>of(Bee::new, MobCategory.MONSTER).sized(0.6F, 1.99F).clientTrackingRange(8), 0xc9b161, 0x353535).withDefaultSounds().build();
	...
	public static final MobReg<Centaur> CENTAUR = new MobReg.Builder<>("centaur", EntityType.Builder.<Centaur>of(Centaur::new, MobCategory.MONSTER).sized(1.3964844F, 1.99F).clientTrackingRange(8), 0x8d4f41, 0x353535).withDefaultSounds().withGender().build();
	public static final MobReg<CobbleGolem> COBBLE_GOLEM = new MobReg.Builder<>("cobble_golem", EntityType.Builder.<CobbleGolem>of(CobbleGolem::new, MobCategory.MONSTER).sized(0.75F, 0.75F).clientTrackingRange(8), 11513775, 11513775).withAttack().withStep().withDeath().build();
	public static final MobReg<CobblestoneGolem> COBBLESTONE_GOLEM = new MobReg.Builder<>("cobblestone_golem", EntityType.Builder.<CobblestoneGolem>of(CobblestoneGolem::new, MobCategory.MONSTER).sized(0.75F, 0.75F).clientTrackingRange(8), 11513775, 11513775).withAttack().withStep().withDeath().build();
	...
	public static final MobReg<Cyclops> CYCLOPS = new MobReg.Builder<>("cyclops", EntityType.Builder.<Cyclops>of(Cyclops::new, MobCategory.MONSTER).sized(0.6F, 1.99F).clientTrackingRange(8), 4936602, 3487029).withDefaultSounds().build();
	public static final MobReg<Dryad> DRYAD = new MobReg.Builder<>("dryad", EntityType.Builder.<Dryad>of(Dryad::new, MobCategory.MONSTER).sized(0.6F, 1.99F).clientTrackingRange(8), 10255437, 5681460).withDefaultSounds().build();
	...
	public static final MobReg<Goblin> GOBLIN = new MobReg.Builder<>("goblin", EntityType.Builder.<Goblin>of(Goblin::new, MobCategory.MONSTER).sized(0.6F, 1.6F).clientTrackingRange(8), 0x718a60, 0x8d4f41).withDefaultSounds().build();
	...
	public static final MobReg<Hunter> HUNTER = new MobReg.Builder<>("hunter", EntityType.Builder.<Hunter>of(Hunter::new, MobCategory.MONSTER).sized(0.6F, 1.99F).clientTrackingRange(8), 0xae6b3c, 0x353535).withDefaultSounds().build();
	...
	public static final MobReg<Satyress> SATYRESS = new MobReg.Builder<>("satyress", EntityType.Builder.<Satyress>of(Satyress::new, MobCategory.MONSTER).sized(0.6F, 1.99F).clientTrackingRange(8), 0x707b4f, 0xa4452d).withDefaultSounds().build();
