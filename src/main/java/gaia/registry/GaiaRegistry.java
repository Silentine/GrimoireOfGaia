...
public class GaiaRegistry {
	...
	public static final MobReg<Valkyrie> VALKYRIE = new MobReg.Builder<>("valkyrie", EntityType.Builder.of(Valkyrie::new, MobCategory.MONSTER).sized(0.6F, 1.99F).clientTrackingRange(8), 0xc9b161, 0xd54242).withDefaultSounds().build();
