...
public class GaiaConfig {
	...
	/* 1.10.2 update feels like it messed around the way entities spawn
	 * The following numbers are used for the biomes tagged (except for underground, hell and sky)
	 * open; 		
	 *		60, 60
	 *		100,80
	 * closed;
	...
	public static int SpawnBaphomet = 4;
	//open;		sky
	...
	//Base Defense
	public static int BaseDefense = 25;
