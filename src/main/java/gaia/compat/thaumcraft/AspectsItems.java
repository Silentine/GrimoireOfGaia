...
public class AspectsItems {
	...
	public static void registerAspects(AspectRegistryEvent event) {
		...
		event.register.registerObjectTag(new ItemStack(BOX, 1, 1),
				(new AspectList()).add(Aspect.VOID, 4).add(Aspect.DESIRE, 4));
		
		event.register.registerObjectTag(new ItemStack(BOX, 1, 2),
				(new AspectList()).add(Aspect.VOID, 4).add(Aspect.DESIRE, 4));
		
		event.register.registerObjectTag(new ItemStack(BAG_ARROW),
		...
		event.register.registerObjectTag(new ItemStack(CHEST, 1, 1),
				(new AspectList()).add(Aspect.VOID, 4).add(Aspect.DESIRE, 4).add(Aspect.ENTROPY, 8));
		
		event.register.registerObjectTag(new ItemStack(CHEST, 1, 2),
				(new AspectList()).add(Aspect.VOID, 4).add(Aspect.DESIRE, 4).add(Aspect.ORDER, 8));
		//	F
		...
		event.register.registerObjectTag(new ItemStack(WEAPON_BOOK_BUFF),
